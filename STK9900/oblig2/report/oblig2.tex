...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/sleepstudy.png}
...
\lstinputlisting[language=R, basicstyle=\ttfamily\scriptsize]{../Rcode/problem1.R}
\subsection*{Problem 2}
\lstinputlisting[language=R, basicstyle=\ttfamily\scriptsize]{../Rcode/problem2.R}
\subsection*{Problem 3}
\lstinputlisting[language=R, basicstyle=\ttfamily\scriptsize]{../Rcode/problem3.R}
\subsection*{Problem 4}
\lstinputlisting[language=R, basicstyle=\ttfamily\scriptsize]{../Rcode/problem4.R}
